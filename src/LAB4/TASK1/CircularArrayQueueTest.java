...
public class CircularArrayQueueTest {
    ...
    CircularArrayQueue carQueue = new CircularArrayQueue(10);
    ...
    public void testAddElement () {
        ...
        assertEquals(3, carQueue.length(), "Queue should have 3 objects");
    }
    ...
    public void testRemoveElement () {
        ...
        assertEquals(2, carQueue.length(), "Queue should have 2 objects after removal. ");
    }
